  ...
  return (
    <div className='relative home'>
      ...
      <div className='min-h-screen flex justify-center items-center'>
        <div>
          <h1 className='text-center text-4xl my-4 font-bold titulo'>FELICITA.ME</h1>
          <div className='bg-zinc-500/60 w-full px-4 py-4 backdrop-blur-0 rounded'>
            <h1 className='text-center my-2 font-bold'>INICIA SESIÓN:</h1>
              ...
              <form onSubmit={onSubmit}>
                ...
                <button type="submit" className='w-full cursor-pointer bg-pink-700 py-2 my-2 hover:bg-pink-800'>Iniciar sesión</button>
              </form>
